...
const ComplainantProfile: React.FC = () => {
  ...
  const fetchProfile = async () => {
    try {
      const res = await apiRequest("GET", `${apiUrl}/api/complainants/user`);
      setUser(res.data);
    } catch (err: any) {
  ...
  const handleLogout = async () => {
    ...
    try {
      const res = await apiRequest("GET", `${apiUrl}/api/complainants/logout`);
            ...
            >
              <Row align="middle" gutter={16}>
                ...
                <Col>
                  ...
                  <Text style={{ color: "#e6f4ff" }}>Complainant Profile</Text>
                </Col>
              </Row>
            </div>
