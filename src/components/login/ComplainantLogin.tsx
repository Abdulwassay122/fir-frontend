...
const ComplainantLogin: React.FC = () => {
  const {
  ...
  return (
    ...
    >
      <Card title="Complainant Login" style={{ width: 400 }}>
        {error && (
          <Alert
            message={error}
            type="error"
        ...
        <div className="text-center flex flex-col gap-2">
          <a
            className="text-[13px] underline-offset-1 text-center"
            href="/register-complainant"
          >
...
export default ComplainantLogin;
